...
5. ยืนยันการจ่ายยา
6. ระบบคำนวณยอดรวม:
   - `subtotal` = รวมราคาทุกรายการ
   - `discount` = ส่วนลดท้ายบิล (บาท)
   - `vat_amount` = 0 (MVP ยังไม่จด VAT)
   - `total_amount` = subtotal - discount
7. ระบบตัดสต๊อกอัตโนมัติ (เฉพาะรายการยา)
8. ระบบสร้าง Transaction + Receipt
...
> **หมายเหตุ:** 
> - รองรับราคา 0 บาท สำหรับกรณียาตัวอย่าง (sample)
> - ส่วนลดเป็นแบบท้ายบิล (ไม่รองรับส่วนลดรายการใน MVP)
> - VAT 7% เตรียม schema ไว้ แต่ซ่อนใน UI จนกว่าจะจดทะเบียน
