...
- [ ] เมื่อไม่มี search/filter ใด ๆ ระบบ **ต้องไม่แสดงข้อมูลนอก today range** หรือของหมออื่น
...
- [ ] Status ใน Doctor Workspace **ไม่มีผลเป็น workflow gate** หรือ disable/enable action ใด ๆ
